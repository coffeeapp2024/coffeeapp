  ...
  return (
    <>
      {isIOS && !isPWAInstalled && (
        <div className="fixed top-28 left-1/2 -translate-x-1/2 w-fit  text-sm bg-background bg-opacity-content1 text-neutral-800 px-5 py-2 rounded-3xl flex flex-col items-center justify-center">
