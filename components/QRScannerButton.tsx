  ...
  return (
    <Dialog open={false} onOpenChange={toggleScanner}>
      <DialogTrigger className="relative z-10 active:scale-[98%]">
        <div className="bg-gradient-to-tr from-amber-300 to-amber-400 h-11 px-4 flex items-center justify-center rounded-xl text-xl text-neutral-800 font-bold text-nowrap border-[1px] border-neutral-800 -z-10">
          Scan QR
