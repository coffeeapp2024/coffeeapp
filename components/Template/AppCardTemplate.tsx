...
function AppCardTemplate({
  ...
  return (
    <div className="col-span-2 w-full aspect-square rounded-3xl shadow-sm overflow-hidden flex flex-col justify-end">
      ...
      <div className="w-full bg-orange-50 px-3 py-3 flex justify-between items-center">
